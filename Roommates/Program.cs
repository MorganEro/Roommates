            ...
            while (runProgram)
            {
                ...
                switch (selection)
                {
                    ...
                    case ("Search for roommate"):
                        ...
                        Console.ReadKey();
                        break;
                    //add a menu option for searching for a roommate by their Id, the output to the screen should output their first name, their rent portion, and the name of the room they occupy
                    ...
                    case ("Assign chore to roommate"):
                        ...
                        Console.Write("Select Chore Id: ");
                        int newChoreId = int.Parse(Console.ReadLine());
                        ...
                        Console.Write("Select Roommate Id: ");
                        int newRoommateId = int.Parse(Console.ReadLine());

                        choreRepo.AssignChore(newRoommateId, newChoreId);
                    ...
                    case ("Get unassigned chores"):
                        ...
                        Console.WriteLine("These chores are unassigned:");
